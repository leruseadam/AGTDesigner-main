#!/usr/bin/env python3
"""
Corrected migration script to transfer all products from SQLite to PostgreSQL
...
def migrate_products():
    ...
    try:
        ...
        # Find common columns (excluding 'id' which is auto-generated in PostgreSQL)
        common_columns = [col for col in sqlite_column_names if col in pg_column_names and col != 'id']
...
if __name__ == "__main__":
    logger.info("Starting corrected SQLite to PostgreSQL migration...")
